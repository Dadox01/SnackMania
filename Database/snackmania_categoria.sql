...
CREATE TABLE `categoria` (
  ...
  CONSTRAINT `prodotto` FOREIGN KEY (`ID_prodotto`) REFERENCES `prodotto` (`ID_prodotto`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `categoria` VALUES (8,'Dolce','Mike and Ike Cherry',8);
